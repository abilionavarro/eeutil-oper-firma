...
El único requisito que debe cumplir la máquina donde se pretenda ejecutar el proyecto **eeutil-oper-firma** es que tenga instalada la aplicación [Docker](https://www.docker.com/)
...
Tras finalizar el proceso, se habrá creado la imagen **eeutil-oper-firma** en el repositorio local de Docker. Se puede consultar dicho repositorio ejecutando el comando:
